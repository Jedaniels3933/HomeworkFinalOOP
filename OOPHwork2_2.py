...
class Book(Products):
    def __init__(self, product_id, product_name, product_price, author , genre):
...
my_new_book = Book("7844154", "Pet Semetary", 20, 'Stephen King', 'horror')
...
another_book = Book(552154, 'American Gods',25, 'Neil Gaiman', 'fantasy')
another_book.display_book_info()
